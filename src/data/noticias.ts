...
},
{
  ...
  pais: 'Colombia',
  resumen: 'En 2021, Gustavo Petro, Gustavo Bolívar e Iván Cepeda protagonizaron un encuentro en el programa #LosGustavos, donde leyeron sus columnas sobre Álvaro Uribe, la justicia y la necesidad de un pacto nacional. Cuatro años después, el video se recuerda como testimonio del origen del Pacto Histórico y de las ideas que marcaron el cambio político del país.',
  ...
  idioma_original: 'es',
  contenido: [
    'En 2021, cuatro años antes de la coyuntura política actual, tres figuras que luego serían decisivas en el rumbo del país compartieron una transmisión en vivo en YouTube. <b>Gustavo Petro</b>, entonces senador y líder de la Colombia Humana; <b>Gustavo Bolívar</b>, guionista y congresista; e <b>Iván Cepeda</b>, senador del Polo Democrático, participaron en el espacio <b>#LosGustavos</b>, un formato de lectura y debate de columnas que cada semana abordaba temas de coyuntura nacional.',
    'El episodio, titulado <b>“Los escándalos de Uribe Vélez”</b>, giró en torno a las investigaciones judiciales y controversias políticas que rodeaban al expresidente Álvaro Uribe. La conversación combinó la lectura de columnas con comentarios sobre la historia reciente de la violencia, la justicia y el papel de Antioquia en la política nacional. En retrospectiva, la transmisión se considera un punto de partida de las ideas que luego darían forma al <b>Pacto Histórico</b>. Petro sería elegido presidente en 2022, Bolívar se convertiría en precandidato en 2025 e Iván Cepeda sería proclamado candidato presidencial ese mismo año.',
    '<b>Gustavo Bolívar: “Uribe no representa al antioqueño promedio”</b>',
    'Bolívar inició la emisión leyendo su columna <b>“Los escándalos de Uribe Vélez”</b>, en la que combinó relato familiar y crítica política. Evocó la vida de su padre, un hombre trabajador y emprendedor, como ejemplo del antioqueño típico: laborioso, honesto y solidario. A partir de ese retrato afirmó que <b>Álvaro Uribe Vélez no representaba esos valores</b>, sino que encarnaba una distorsión del carácter paisa. Para sostener su tesis, presentó siete argumentos principales:',
    '1. <b>La mentira como herramienta política:</b> acusó a Uribe de construir su liderazgo mediante falsedades, citando el plebiscito por la paz de 2016 y las versiones sobre los “falsos positivos”.',
    '2. <b>El abandono del sentido de comunidad:</b> afirmó que durante su influencia política, Medellín se convirtió en la ciudad más desigual de Colombia, en contravía de la solidaridad tradicional antioqueña.',
    '3. <b>La relación con las estructuras armadas:</b> recordó que como gobernador de Antioquia (1995–1997) impulsó las cooperativas Convivir, base de las Autodefensas Unidas de Colombia (AUC).',
    '4. <b>La responsabilidad moral en la violencia:</b> señaló que las masacres aumentaron de forma drástica en Antioquia durante su administración y que su modelo contribuyó a la concentración de la tierra.',
    '5. <b>La corrupción y el favorecimiento de allegados:</b> mencionó obras públicas cuestionadas como la Ruta del Sol II, el Túnel de la Línea e Hidroituango.',
    '6. <b>La cobardía ante la justicia:</b> consideró que al renunciar al Senado en 2020 para evitar la competencia de la Corte Suprema, Uribe mostró temor a rendir cuentas.',
    '7. <b>El engaño mediático:</b> lo responsabilizó de instaurar la cultura de la posverdad, con montajes judiciales y campañas de desinformación.',
    'Bolívar concluyó su lectura llamando a los jóvenes a impulsar un cambio pacífico a través del <b>Pacto Histórico</b>. “Colombia ya no tiene nada que perder; si no es ahora, no será nunca”, afirmó, aludiendo a la necesidad de romper con dos décadas de gobiernos de derecha.',
    '<b>Gustavo Petro: “El Pacto Histórico es un contrato social para la paz”</b>',
    'A continuación, Petro presentó su columna <b>“El Pacto Histórico”</b>, en la que definió el proyecto como un contrato social nacional para reemplazar la guerra por convivencia y justicia. Inspirado en Rousseau, explicó que el pacto debía ser un acuerdo entre todos los sectores de la sociedad: campesinos, indígenas, afrodescendientes, trabajadores, mujeres y empresarios. No se trataba de una alianza electoral, sino de un proceso histórico que debía abarcar varios gobiernos sucesivos.',
    ...
    '<b>Debate conjunto: memoria, justicia y futuro político</b>',
    ...
    '<b>Proyección histórica y significado actual (2025)</b>',
    'Cuatro años después, el análisis de esa transmisión permite comprender cómo <b>la alianza discursiva entre Petro, Bolívar y Cepeda dio origen al proyecto político que hoy gobierna el país</b>. Las ideas expuestas en 2021 —la paz como contrato social, la justicia independiente, la igualdad de género y la crítica al autoritarismo— anticiparon el cambio de ciclo político que comenzó con la elección de Petro en 2022 y continuó con la candidatura presidencial de Cepeda en 2025.',
...
},
{
  ...
  fecha: '2025-10-26',
  titulo: 'La consulta interna del Pacto Histórico tuvo más de 2,7 millones de votantes',
  pais: 'Colombia',
  resumen: 'Con 1.527.549 votos (65,14 %), Iván Cepeda ganó la consulta del Pacto Histórico y será el candidato presidencial de la izquierda. Boletín oficial de la Registraduría con avance del 98.93%.',
  ...
  contenido: [
    ...
    'Según el boletín de la Registraduría Nacional del Estado Civil con avance del 98.93 %, Cepeda obtuvo 1.527.549 votos (65,14 %). Diana Carolina Corcho Mejía registró 673.343 votos (28,71 %) y Daniel Quintero Calle 144.010 votos (6,14 %). En total participaron 2.726.735 votantes, con 243.645 votos no marcados y 138.188 nulos.',
